...
import ResNFNonAutoSDE as Mymodule
import Evaulation
imp.reload(Mymodule)
...
flags.DEFINE_string('test_name',   'Ex43SSAmRNAwDynk',                'Name of test')
flags.DEFINE_string('config_path', './configs/Ex43SSAmRNAwDynk.json', 'Path of config file')
