...
import ResNFSDE  as Mymodel1
import ResNFSDE_SSAgenconserve  as Mymodel2
import Evaulation
imp.reload(Mymodel1)
imp.reload(Mymodel2)
...
### 7.  Ex7MdOU 						  ./configs/Ex7MdOU.json
### 8.  Ex8DW 						      ./configs/Ex8DW.json
### 10. Ex10SO 						      ./configs/Ex10SO.json

flags.DEFINE_string('test_name',   'Ex35MultiScaleChaoticNoise',                'Name of test')
flags.DEFINE_string('config_path', './configs/Ex35MultiScaleChaoticNoise.json', 'Path of config file')
flags.DEFINE_string('model_name',  'ResNFSDE',                        'Name of model')
FLAGS = flags.FLAGS

def Model_select(model_name):
	if model_name=='ResNFSDE':
		return Mymodel1
...
def main(argv):
	...
	## Only difference with 'SolveNFSDE.py' ##
