...
import NFNonAutoSDE  as Mymodule
import Evaulation
imp.reload(Mymodule)
...
### 2. Ex15StochasticRes                ./configs/Ex15StochasticRes.json
### 3. Ex16Multiscale                   ./configs/Ex16Multiscale.json

flags.DEFINE_string('test_name',   'SPDEEx3SHeatEqu_wSourceModal',                'Name of test')
flags.DEFINE_string('config_path', './configs/SPDEEx3SHeatEqu_wSourceModal.json', 'Path of config file')
